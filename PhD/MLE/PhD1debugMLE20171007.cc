...
int main()
{
 ...
 //    map<DASS, FProb> safety_p = create_DT_from_textfile(fname,rv_count, contents_length);
	...
	jointPtr = absorb(factorPtrs);
	cout<<*jointPtr->normalize()<<endl;
	std::cout << "*******************************************   p(maint,lug_boot)" << endl;
	tstPtr = jointPtr->marginalize({maint,lug_boot}, false);
	cout << *tstPtr <<endl;
 ...
 //cout << *cgPtr << endl;
    ...
    cgfile.close();
 	...
 	// cout<< "safety"<<endl;
 	// qPtr = queryLBU_CG( *cgPtr, msgs, {safety})->normalize();
 	// cout<<*qPtr<<endl;
 	// cout<< "persons"<<endl;
 	// qPtr = queryLBU_CG( *cgPtr, msgs, {p})->normalize();
 	// cout<<*qPtr<<endl;
 	...
 	cout<<*qPtr<<endl;
 	cout<< "lug_boot"<<endl;
 	qPtr = queryLBU_CG( *cgPtr, msgs, {lug_boot})->normalize();
 	cout<<*qPtr<<endl;
